...
const STATUS_ICON_LIBRARY = {
  ...
  healer_blessing: { glyph: 'SW', name: 'Sacred Ward', fg: '#f4e6ff', bg: '#2e1a3a', border: '#a36fd6', description: 'Sacred boon improving accuracy and mana.' },
  hide: { glyph: 'HD', name: 'Hidden', fg: '#d7f0ff', bg: '#14202b', border: '#5f90b3', description: 'Vanished from the back row — +35 Evasion. Your next attack from stealth gets +15 Accuracy. Ends immediately (no bonus) if you are hit.' },
  hide_reward: { glyph: 'SA', name: 'Sneak Advantage', fg: '#d7f0ff', bg: '#14202b', border: '#5f90b3', description: 'Went unnoticed — +15 Accuracy on your next attack.' },
  blessing: { glyph: 'BL', name: 'Blessing', fg: '#f4e6ff', bg: '#2e1a3a', border: '#a36fd6', description: 'Improved Accuracy and damage.' },
  watch_over: { glyph: 'WO', name: 'Watched Over', fg: '#e6f1ff', bg: '#1e2533', border: '#6a88b8', description: 'Guarded by an ally — all Resists improved. Lasts longer if struck.' },
  shepherd_mark: { glyph: 'SM', name: "Shepherd's Mark", fg: '#ffd1d1', bg: '#3b1d1d', border: '#b24a4a', description: 'Takes +20% bonus damage from the Shepherd who marked it (added to that hit, not a separate damage type).' },
  blockade: { glyph: 'BK', name: 'Blockade', fg: '#ffe0ba', bg: '#2f2315', border: '#c08c49', description: 'Braced defensively (front row only) — all Resists improved, and enemies can only target the front row.' },
  transpose_fire: { glyph: 'TF', name: 'Transpose: Fire', fg: '#ffcba4', bg: '#3a2316', border: '#c77232', description: "Next hit's buildup is converted entirely into Fire." },
  transpose_lightning: { glyph: 'TL', name: 'Transpose: Lightning', fg: '#fff3b0', bg: '#3a3410', border: '#c7ab32', description: "Next hit's buildup is converted entirely into Lightning." },
  transpose_cold: { glyph: 'TC', name: 'Transpose: Cold', fg: '#c3eaff', bg: '#172a38', border: '#5fa0c8', description: "Next hit's buildup is converted entirely into Cold." },
  ...
  rhythm_stack: { glyph: 'RH', name: 'Rhythm', fg: '#ffe4c9', bg: '#332318', border: '#c9926c', description: '+5% generic increased damage per stack (max 3). Gaining a stack refreshes ALL stacks to 2 turns.' },
  glacial_scorch: { glyph: 'GS', name: 'Trapped Fire', fg: '#ffd7b3', bg: '#3a2010', border: '#cc7a33', description: 'Fire buildup taken is increased; lingering fire burns at end of turn.' },
