...
Camp Nehemiah has two separate rows of trade, each with its own currency.
...
- Nahlia Vey (Elseth), Vashra Lyle (Styx), Baruun (Zafaar), Aivorel (Le'sse)

Each tribe vendor sells only to their own tribe's Hunters, trading tribe-unique pendants for Tribe Tickets.
