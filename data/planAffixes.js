...
export const PLAN_FIELDS = {
  ...
  lootQualityPercent:      { label: 'Loot Quality', unit: '%', live: true,
    reader: 'rollHuntDropRarity (PartyStats.js), called by CombatScene' },
  ...
  travelTimePercent:       { label: 'Travel Time Saved', unit: '%', live: false,
    reader: 'partyStats adds it after the Speed curve; HuntRules.moveCost reads it (map hunts, HuntEngine.js; live once chunk 8 runs hunts on the map)' },
