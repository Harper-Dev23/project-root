...
export const AWAKENINGS = {
  ...
  acolyte: [
    ...
    },
    {
      ...
      name: 'Crusader',
      motif: 'The Sword',
      motifDesc: 'A cross-hilted blade: a wide guard of stars above, narrowing down the blade to a single point.',
      nodes: [
        { n: 'Sworn Witness',  t: 1, x: 0.16, y: 0.10 },
        { n: 'The Hush',       t: 1, x: 0.50, y: 0.10 },
        { n: 'First Sentence', t: 1, x: 0.84, y: 0.10 },
        { n: 'Sigil-Cut Steel',    t: 2, x: 0.22, y: 0.32 },
        { n: 'Weight of Judgment', t: 2, x: 0.40, y: 0.28 },
        { n: 'Unflinching',        t: 2, x: 0.60, y: 0.28 },
        { n: 'Banner of the Just', t: 2, x: 0.78, y: 0.32 },
        { n: 'Cleave the Stone', t: 3, x: 0.30, y: 0.56 },
        { n: 'No Warning',       t: 3, x: 0.42, y: 0.52 },
        { n: 'Inflexible Wrath', t: 3, x: 0.60, y: 0.52 },
        { n: "Enforcer's Mark",  t: 3, x: 0.72, y: 0.56 },
        { n: 'The Sentence Falls', t: 4, x: 0.50, y: 0.90 },
      ],
      edges: [[0,3],[1,4],[1,5],[2,6],[3,7],[4,8],[5,9],[6,10],[7,11],[8,11],[9,11],[10,11],[4,5,'link'],[8,9,'link']],
    },
    {
      id: 'sage',
      name: 'Sage',
